...
def main(args):
    ...
    while True:
        ...
        assert locations.shape[0] == 68 and scores.shape[0] == 68, 'The number of points is {} vs {} vs {} vs {}'.format(68, xpoints.shape, locations.shape, scores.shape)
